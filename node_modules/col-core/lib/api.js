...
var initializeServer = function(callback) {
  ...
  // TODO: This is temporary and should be removed as soon as the Apache
  // config file is available in master
...
var initializeAuthorizationMiddleware = function(apiRouter) {
  ...
  apiRouter.use(function(req, res, next) {
    ...
    UsersAPI.getUserByBookmarkletToken(userId, bookmarkletToken, function(err, user) {
      // If a valid user was found, add the current user and course to the request
      if (user) {
