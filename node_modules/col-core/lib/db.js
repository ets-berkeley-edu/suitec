...
var setUpModel = function(sequelize) {
   ...
   *
   * @property  {String}      canvas_api_domain       The domain on which canvas is running on
  ...
  Course.belongsTo(Canvas, {'onDelete': 'CASCADE', 'as': 'canvas'});
   ...
   * @property  {String}        bookmarklet_token       The bookmarklet token of the user
   */
  ...
  var Activity = module.exports.Activity = sequelize.define('activity', {
    ...
    'object_type': {
      'type': Sequelize.ENUM(objectTypes),
      'allowNull': false
    }
  }, {
    'underscored': true
   ...
   * @property  {Number}        points              The number of points this activity contributes towards a user's engagement index
   * @property  {Boolean}       enabled             Whether activities of this type should be contributed towards a user's engagement index
   */
   ...
   * @property {Number}     comment_count             The number of people who commented on the asset
   */
