...
var ActivityDefaults = require('col-activity/lib/default');
...
var setUpModel = function(sequelize) {
  ...
  var Activity = module.exports.Activity = sequelize.define('activity', {
    'type': {
      'type': Sequelize.ENUM(_.keys(ActivityDefaults)),
      'allowNull': false
    },
    'object_id': {
      'type': Sequelize.INTEGER,
   ...
   *
   * @property  {String}      type                    The activity type. One of the keys in `col-activity/lib/constants.js`
