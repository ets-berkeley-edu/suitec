...
var setUpModel = function(sequelize) {
   ...
   * @property {Number}       online_count            The number of users currently available in the whiteboard
   */
  ...
  /**
   * The `whiteboard_session` table will keep track of the online users for each whiteboard in the Whiteboard tool.
