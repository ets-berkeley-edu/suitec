...
var setUpModel = function(sequelize) {
  ...
  var Asset = module.exports.Asset = sequelize.define('asset', {
    ...
    'instanceMethods': {
      'toJSON': function() {
        ...
        // Order the asset's categories on their title
        if (!_.isEmpty(asset.categories)) {
          asset.categories = _.sortBy(asset.categories, 'title');
        }

        // Order the asset's comments on their last updated timestamp
        if (!_.isEmpty(asset.comments)) {
          asset.comments = _.sortBy(asset.comments, 'updated_at');
        }
   ...
   * @property  {String}      element                 The stringified serialized whiteboard element
   */
