              ...
              TestsUtil.getAssetLibraryClient(null, course, null, function(clientC, course, userC) {
                UsersTestUtil.assertGetMe(clientC, course, null, function(meC) {
                  ...
                  WhiteboardsTestUtil.assertCreateWhiteboard(clientA, course, 'UC Berkeley Whiteboard', meB.id, function(whiteboard) {
                    WhiteboardsTestUtil.assertEditWhiteboard(clientA, course, whiteboard.id, 'UC Davis Whiteboard', [meA.id, meC.id], function(whiteboard) {
              ...
              TestsUtil.getAssetLibraryClient(null, null, null, function(clientC, courseB, userC) {
                UsersTestUtil.assertGetMe(clientC, courseB, null, function(meC) {
                  ...
                  WhiteboardsTestUtil.assertCreateWhiteboard(clientA, courseA, 'UC Berkeley Whiteboard', meB.id, function(whiteboard) {
                    ...
                    // Invalid whiteboard id
                    WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, 'Not a number', 'UC Davis Whiteboard', [meA.id, meB.id], 400, function() {
                      WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, -1, 'UC Davis Whiteboard', [meA.id, meB.id], 404, function() {
                        WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, 234234233, 'UC Davis Whiteboard', [meA.id, meB.id], 404, function() {

                          // Missing title
                          WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, null, [meA.id, meB.id], 400, function() {
                            WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, '', [meA.id, meB.id], 400, function() {
                              // Too long title
                              WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, randomstring.generate(256), [meA.id, meB.id], 400, function() {

                                // Invalid user
                                WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, 'UC Davis Whiteboard', [meA.id, 'invalid'], 400, function() {
                                  WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, 'UC Davis Whiteboard', [meA.id, 4242], 404, function() {

                                    // User from different course
                                    WhiteboardsTestUtil.assertEditWhiteboardFails(clientA, courseA, whiteboard.id, 'UC Davis Whiteboard', [meA.id, meC.id], 404, function() {
                  ...
                  TestsUtil.getAssetLibraryClient(null, courseA, adminUserA, function(clientD, courseA, adminUserA) {
                    ...
                    TestsUtil.getAssetLibraryClient(null, null, adminUserB, function(clientE, courseB, adminUserB) {
                      ...
                      WhiteboardsTestUtil.assertCreateWhiteboard(clientA, courseA, 'UC Berkeley Whiteboard', meB.id, function(whiteboard) {
                        ...
                        WhiteboardsTestUtil.assertEditWhiteboard(clientA, courseA, whiteboard.id, 'UC Davis Whiteboard', [meA.id, meB.id], function(whiteboard) {

                          // Verify that the whiteboard can be edited by a different member of the whiteboard
                          WhiteboardsTestUtil.assertEditWhiteboard(clientB, courseA, whiteboard.id, 'UC Merced Whiteboard', [meA.id, meB.id], function(whiteboard) {

                            // Verify that the whiteboard can be edited by an administrator of the course
                            WhiteboardsTestUtil.assertEditWhiteboard(clientD, courseA, whiteboard.id, 'UC Santa Cruz Whiteboard', [meA.id, meB.id], function(whiteboard) {

                              // Verify that the whiteboard can not be edited by a different non-administrator user
                              WhiteboardsTestUtil.assertEditWhiteboardFails(clientC, courseA, whiteboard.id, 'UCLA Whiteboard', [meA.id, meC.id], 404, function() {

                                // Verify that an administrator in a different course can not edit the whiteboard
                                WhiteboardsTestUtil.assertEditWhiteboardFails(clientE, courseB, whiteboard.id, 'UCLA Whiteboard', [meA.id, meC.id], 404, function() {
