...
var generateThumbnail = function(whiteboard, callback) {
  ...
  getWhiteboardAsPngFile(whiteboard, function(err, imagePath) {
    ...
    var cleanupFile = _.once(function(err, whiteboard) {
    ...
    var done = _.after(2, function() {
      ...
      return updateWhiteboardPreview(whiteboard, update, cleanupFile);
    });
    ...
    embdr.process(imagePath, {
      'thumbnails': {
        ...
        'complete': function(thumbnails) {
          thumbnailUrl = thumbnails[CollabosphereConstants.THUMBNAIL_SIZE].url;
          done();
        }
      },
      'images': {
        ...
        'complete': function(images) {
          imageUrl = images[CollabosphereConstants.IMAGE_SIZE].url;
          done();
        }
      },

      // Add a complete callback in case the thumbnails or images processing failed. If they both
      // succeeded, this function will essentially become a noop
      'complete': done,
      'error': function(err) {
        log.error({
          'err': err,
