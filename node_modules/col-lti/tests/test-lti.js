  ...
  describe('Asset Library', function() {
    ...
    describe('Tool', function() {
      ...
      it('can support the same client in two courses concurrently', function(callback) {
        ...
        var client = TestsUtil.getAnonymousClient();
        var courseBerkeley = TestsUtil.generateCanvasCourse(global.tests.canvas.ucberkeley);
        LtiTestsUtil.getAssetLibraryClient(client, courseBerkeley, null, function() {

          // Launch the same client in a UC Davis course
          var courseDavis = TestsUtil.generateCanvasCourse(global.tests.canvas.ucdavis);
          LtiTestsUtil.getAssetLibraryClient(client, courseDavis, null, function() {

            // Getting the me feed in the UC Berkeley course should work
            UsersTestsUtil.assertGetMe(client, courseBerkeley, function(me) {
              ...
              UsersTestsUtil.assertGetMe(client, courseDavis, function(me) {
