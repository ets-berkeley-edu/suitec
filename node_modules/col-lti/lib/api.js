...
var launch = module.exports.launch = function(req, callback) {
  ...
  CanvasAPI.getCanvas(canvas_api_domain, consumer_key, function(err, canvas) {
    ...
    provider.valid_request(req, function(err, isValid) {
      ...
      CourseAPI.getOrCreateCourse(canvas_course_id, canvas, function(err, course) {
        if (err) {
          return callback(err);
        }
 ...
 *
 * @param  {String}     protocol        The protocol on which the cartridge is retrieved
 ...
 */
var getBasicLTICartridge = module.exports.getBasicLTICartridge = function(protocol, host, toolId, title, description) {
  ...
  xml += '        <lticm:property name="default">enabled</lticm:property>';
