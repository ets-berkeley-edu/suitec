...
Collabosphere.ltiRouter.get('/assetlibrary.xml', function(req, res) {
  var xml = LtiAPI.getBasicLTICartridge(req.protocol, req.headers.host, LtiConstants.assetLibrary.ID, LtiConstants.assetLibrary.TITLE, LtiConstants.assetLibrary.DESCRIPTION);
