...
var getCanvas = module.exports.getCanvas = function(apiDomain, ltiKey, callback) {
  ...
  DB.Canvas.findOne(options).complete(function(err, canvas) {
    if (err) {
      ...
      log.warn({'err': err}, 'No credentials exist for the given api_domain and consumer_key');
      return callback({'code': 400, 'msg': 'No credentials exist for the given api domain and consumer key'});
    }
