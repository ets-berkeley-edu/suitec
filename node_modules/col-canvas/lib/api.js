...
/**
 * Get the base URI on which the Canvas API can be reached. This includes the protocol and hostname.
 *
 * @param  {Context}        ctx                   Standard context containing the current user and the current course
 * @return {String}                               The base URI on which the Canvas API can be reached
 * @api private
 */
