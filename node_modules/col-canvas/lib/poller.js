...
var pollUsers = function(ctx, users, callback) {
  // TODO: Include users who completed the course
  CanvasAPI.getCourseUsers(ctx.course, null, function(err, canvasUsers) {
    if (err) {
      return callback(err);
    }
...
var pollAssignments = function(ctx, users, callback) {
  CanvasAPI.getAssignments(ctx.course, function(err, assignments) {
    ...
    var assignmentIterator = handleAssignment.bind(null, ctx, users);
 ...
 * @api private
 */
var handleAssignment = function(ctx, users, assignment, callback) {
