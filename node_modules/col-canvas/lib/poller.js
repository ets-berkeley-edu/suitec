...
var handleCourse = module.exports.handleCourse = function(course, callback) {
  ...
  getAllUsers(ctx, function(err, users) {
    ...
    pollAssignments(ctx, users, function(err) {
      ...
      return pollDiscussions(ctx, users, callback);
    });
  });
};
...
var handleSubmission = function(ctx, users, assignment, activities, submission, callback) {
  ...
  return createActivity(ctx, activities, users, activity, callback);
};
...
var handleDiscussion = function(ctx, activities, users, discussion, callback) {
  ...
  createActivity(ctx, activities, users, activity, function(err) {
    if (err) {
      return callback(err);
 ...
 * @api private
 */
var createActivity = function(ctx, activities, users, activity, callback) {
  ...
  return ActivitiesAPI.createActivity(ctx.course, user, activity.type, activity.objectId, activity.objectType, actor, callback);
};
