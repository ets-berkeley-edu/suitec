 ...
 */
var CanvasUser = module.exports.CanvasUser = function(name, courseId, enrollmentState, role) {
 ...
 */
var CanvasAssignment = module.exports.CanvasAssignment = function(courseId, submissions, name, published) {
  assignmentIds++;
  var id = assignmentIds;
  if (!name) {
    name = 'Assignment ' + id;
  }
  if (published !== false) {
 ...
 * @param  {String}                   type                  The submission type, one of `online_url`, `online_text_entry` or `online_upload`
 * @param  {String|CanvasFile[]}      submissionValue       The URL, file(s) or text of the submission
 ...
 * @param  {Boolean}    expectProcessing    Whether this file is expected to be down- and uploaded, defaults to `true`
