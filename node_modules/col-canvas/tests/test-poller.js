            ...
            getCourse(course.id, function(dbCourse) {
              ...
              CanvasPoller.handleCourse(dbCourse, function(err) {
                ...
                UsersTestUtil.assertGetLeaderboard(client1, course, 3, false, function(users) {
                  ...
                  // Entries on an assigned discussion count as a submission on the assignment
                  ...
                  CanvasPoller.handleCourse(dbCourse, function(err) {
                    ...
                    // Event though they technically submitted an assignment, activities should only
                    // be created for replying (and getting a reply) on the discussion. Assert no more
                    // points than that were earned
                    UsersTestUtil.assertGetLeaderboard(client1, course, 3, false, function(users) {
