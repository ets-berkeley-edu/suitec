 ...
 * @param  {Object}     defaults                        A set of properties to create the user object with. If the user already exist, it will be updated using these properties
...
var getOrCreateUser = module.exports.getOrCreateUser = function(canvasUserId, course, defaults, callback) {
  ...
  DB.User.findOrCreate(options).complete(function(err, data) {
    ...
    // values supplied by Canvas
      ...
      user.updateAttributes(defaults).complete(function(err, user) {
        if (err) {
