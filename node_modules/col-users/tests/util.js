 ...
 * @param  {String}             [opts.expectedType]         Whether a "basic" or "points" user should be expected
...
var assertUser = module.exports.assertUser = function(user, opts) {
  ...
  // If the user is returned as part of a leaderboard, some properties such as their points
  // and whether they're sharing their points should be returned
  if (opts.expectedType === 'points') {
  ...
  // Basic users shouldn't contain that information
  } else if (opts.expectedType === 'basic') {
...
/**
 * Assert that the users for the current course can be retrieved
 *
 * @param  {Client}             client              The REST client to make the request with
 * @param  {Course}             course              The Canvas course the user is launched in
 ...
 * @throws {AssertionError}                         Error thrown when an assertion failed
 */
var assertGetUsers = module.exports.assertGetUsers = function(client, course, expectedTotal, callback) {
  client.users.getUsers(course, function(err, users) {
    ...
    _.each(users, function(user) {
      assertUser(user, {'expectedType': 'basic'});
...
var assertGetLeaderboard = module.exports.assertGetLeaderboard = function(client, course, expectedTotal, expectEveryone, callback) {
  client.users.getLeaderboard(course, function(err, users) {
    ...
    _.each(users, function(user) {
      assertUser(user, {'expectedType': 'points', 'allowNotSharePoints': expectEveryone});
    });
