...
describe('Users', function() {
  ...
  describe('Points', function() {
    ...
    describe('Get users', function() {
          ...
          TestsUtil.getAssetLibraryClient(null, course, null, function(client2, course, user2) {
            TestsUtil.getAssetLibraryClient(null, course, null, function(client3, course, user3) {
              ...
              UsersTestUtil.assertUpdateSharePoints(client1, course, true, function(me1) {
                ...
                UsersTestUtil.assertGetUsers(client1, course, 1, false, function(users) {
                  UsersTestUtil.assertUser(users[0], me1);
                  ...
                  UsersTestUtil.assertUpdateSharePoints(client2, course, false, function(me2) {
                    ...
                    UsersTestUtil.assertGetUsers(client1, course, 1, false, function(users) {
                      ...
                      UsersTestUtil.assertUpdateSharePoints(client2, course, true, function(me2) {
                        ...
                        UsersTestUtil.assertGetUsers(client2, course, 2, false, function(users) {
                          UsersTestUtil.assertUser(users[0], me1);
                          UsersTestUtil.assertUser(users[1], me2);
      ...
      /**
       * Test that verifies that the users for the current course and their points can be listed as an administrator
       */
      it('can be retrieved as an administrator', function(callback) {
          ...
          TestsUtil.getAssetLibraryClient(null, course, null, function(client1, course, user1) {
            TestsUtil.getAssetLibraryClient(null, course, null, function(client2, course, user2) {
              TestsUtil.getAssetLibraryClient(null, course, null, function(client3, course, user3) {
                ...
                UsersTestUtil.assertGetUsers(adminClient, course, 4, true, function(users) {
          ...
          TestsUtil.getAssetLibraryClient(null, course, null, function(client2, course, user2) {
            TestsUtil.getAssetLibraryClient(null, course, null, function(client3, course, user3) {
              ...
              UsersTestUtil.assertUpdateSharePoints(client1, course, true, function(me1) {
                ...
                UsersTestUtil.assertGetUsersFails(client2, course, 401, function() {
