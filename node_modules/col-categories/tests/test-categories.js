...
describe('Categories', function() {
  ...
  describe('Get categories', function() {
          ...
          TestsUtil.getAssetLibraryClient(null, course, adminUser, function(client2, course, adminUser) {
            CategoriesTestUtil.assertCreateCategory(client2, course, 'Category 1', function(category1) {
              CategoriesTestUtil.assertGetCategories(client1, course, 1, function(categories) {
                CategoriesTestUtil.assertCategory(categories[0], category1, true);
                ...
                CategoriesTestUtil.assertCreateCategory(client2, course, 'Category 2', function(category2) {
                  CategoriesTestUtil.assertGetCategories(client1, course, 2, function(categories) {
                    CategoriesTestUtil.assertCategory(categories[0], category1, true);
                    CategoriesTestUtil.assertCategory(categories[1], category2, true);
    ...
    it('returns asset count', function(callback) {
      var adminUser = TestsUtil.generateAdminUser();
      TestsUtil.getAssetLibraryClient(null, null, adminUser, function(client1, course, adminUser) {
                  ...
                  CategoriesTestUtil.assertCreateCategory(client3, course2, 'Category 2', function(category2) {
                    CategoriesTestUtil.assertEditCategoryFails(client1, course2, category2.id, 'Updated category 2', 401, function() {
                      ...
                      CategoriesTestUtil.assertGetCategories(client3, course2, 1, function(categories) {
                        CategoriesTestUtil.assertCategory(categories[0], category2, true);
          ...
          CategoriesTestUtil.assertCreateCategory(client1, course, 'Category 2', function(category2) {
            ...
            TestsUtil.getAssetLibraryClient(null, course, null, function(client2, course, user2) {
              ...
              AssetsTestUtil.assertCreateLink(client2, course, 'UC Davis', 'http://www.ucdavis.edu/', opts, function(asset1) {
                CategoriesTestUtil.assertCategory(asset1.categories[0], category1);
                ...
                AssetsTestUtil.assertCreateLink(client2, course, 'UC Davis', 'http://www.ucdavis.edu/', opts, function(asset2) {
                  CategoriesTestUtil.assertCategory(asset2.categories[0], category1);
                  CategoriesTestUtil.assertCategory(asset2.categories[1], category2);
                  ...
                  CategoriesTestUtil.assertDeleteCategory(client1, course, category1.id, function() {
                    ...
                    AssetsTestUtil.assertGetAsset(client2, course, asset1.id, null, 0, function(asset) {
                      ...
                      AssetsTestUtil.assertGetAsset(client2, course, asset2.id, null, 0, function(asset) {
                        ...
                        CategoriesTestUtil.assertCategory(asset.categories[0], category2);
