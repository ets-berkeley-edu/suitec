 ...
 */
var getCategories = module.exports.getCategories = function(ctx, includeDeleted, callback) {
 ...
 */
var createCategory = module.exports.createCategory = function(ctx, title, canvasAssignmentId, canvasAssignmentName, callback) {
  // Parameter validation
  var validationSchema = Joi.object().keys({
 ...
 * @param  {String}         [canvasAssignmentName]          The updated name of the assignment in Canvas
 * @param  {Function}       callback                        Standard callback function
 * @param  {Object}         callback.err                    An error that occurred, if any
 * @param  {Category}       callback.category               The updated category
 */
var editCategory = module.exports.editCategory = function(ctx, id, title, canvasAssignmentName, callback) {
  // Parameter validation
  var validationSchema = Joi.object().keys({
