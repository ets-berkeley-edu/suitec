...
Collabosphere.apiRouter.post('/categories', function(req, res) {
  CategoriesAPI.createCategory(req.ctx, req.body.title, undefined, function(err, category) {
    if (err) {
      return res.status(err.code).send(err.msg);
    }
...
Collabosphere.apiRouter.post('/categories/:categoryId', function(req, res) {
  CategoriesAPI.editCategory(req.ctx, req.params.categoryId, req.body.title, function(err, category) {
    if (err) {
      return res.status(err.code).send(err.msg);
    }
