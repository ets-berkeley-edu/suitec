...
/**
 * Generate a fake Canvas Course admin that can be used to launch a tool. All of the inputs
 * are optional and will be generated if omitted.
 ...
 */
var generateAdminUser = module.exports.generateAdminUser = function(canvas, id, roles, givenName, familyName, loginId, userImage) {
 ...
 * @return {User}                                     An object that contains the information about the user
 */
var generateInstructor = module.exports.generateInstructor = function(canvas, id, roles, givenName, familyName, loginId, userImage) {
