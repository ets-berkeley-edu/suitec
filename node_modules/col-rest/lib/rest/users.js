...
module.exports = function(client) {
   ...
   *
   * @param  {CanvasCourse}   course                          The Canvas course in which the user is interacting with the API
  ...
  client.users.getMe = function(course, callback) {
    var url = client.util.apiPrefix(course) + '/me';
    client.request(url, 'GET', null, null, callback);
  };
};
