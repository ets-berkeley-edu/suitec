...
var setup = module.exports.setup = function(client) {
   ...
   *
   * @param  {CanvasCourse}   course    The Canvas course in which the API request takes place
   * @return {String}                   The URL prefix to reach API endpoints on for the given Canvas course
   */
  client.util.apiPrefix = function(course) {
    return '/api/courses/' + client.util.encodeURIComponent(course.canvas.canvas_api_domain) + '/' + client.util.encodeURIComponent(course.id);
  };
};
