...
describe('Activity Points', function() {
  ...
  describe('Commenting', function() {
    ...
    /**
     * Test that verifies that creating a comments updates the points for the appropriate users
     */
            ...
            AssetsTestUtil.assertCreateLink(client1, course, 'UC Davis', 'http://www.ucdavis.edu/', null, function(asset1) {
              AssetsTestUtil.assertCreateLink(client2, course, 'UC Davis', 'http://www.ucdavis.edu/', null, function(asset2) {
                AssetsTestUtil.assertCreateLink(client3, course, 'UC Davis', 'http://www.ucdavis.edu/', null, function(asset3) {
                  ...
                  ActivitiesTestUtil.assertCreateCommentActivity(client1, client1, null, course, asset1.id, null, function() {
                    ActivitiesTestUtil.assertCreateCommentActivity(client1, client2, null, course, asset2.id, null, function() {
                            ...
                            AssetsTestUtil.assertCreateComment(client1, course, asset2.id, 'A top-level comment by user 1 on asset 2', null, function(commentOnAsset2By1) {
                              AssetsTestUtil.assertCreateComment(client2, course, asset2.id, 'A top-level comment by user 2 on asset 2', null, function(commentOnAsset2By2) {
                                AssetsTestUtil.assertCreateComment(client3, course, asset2.id, 'A top-level comment by user 3 on asset 2', null, function(commentOnAsset2By3) {
                                  ...
                                  // Verify replies on top-level comments
                                  ActivitiesTestUtil.assertCreateCommentActivity(client1, client1, client1, course, asset1.id, commentOnAsset1By1.id, function() {
                                    ActivitiesTestUtil.assertCreateCommentActivity(client1, client1, client2, course, asset1.id, commentOnAsset1By2.id, function() {
                                      ActivitiesTestUtil.assertCreateCommentActivity(client1, client2, client1, course, asset2.id, commentOnAsset2By1.id, function() {
                                        ActivitiesTestUtil.assertCreateCommentActivity(client1, client2, client2, course, asset2.id, commentOnAsset2By2.id, function() {
                                          ActivitiesTestUtil.assertCreateCommentActivity(client1, client1, client3, course, asset1.id, commentOnAsset1By3.id, function() {
                                            ActivitiesTestUtil.assertCreateCommentActivity(client1, client2, client3, course, asset2.id, commentOnAsset2By3.id, function() {
                                              return callback();
                                            });
                                          });
                                        });
