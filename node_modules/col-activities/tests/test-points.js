...
describe('Activity Points', function() {
  ...
  describe('Create a new asset', function() {
    ...
    /**
     * Test that verifies that creating a new link asset increases the points for the creator
     */
    it('increases the points', function(callback) {
      TestsUtil.getAssetLibraryClient(null, null, null, function(client, course, user) {
        // Verify that creating a new link asset correctly increases the points
        ActivitiesTestUtil.assertCreateLinkActivity(client, course, 'UC Davis', 'http://www.ucdavis.edu/', null, function(asset1) {
          // Verify that creating another link asset correctly increases the points
