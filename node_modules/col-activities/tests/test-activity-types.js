        ...
        ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 'foo', 10, null, 400, function() {
          ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 1, 10, null, 400, function() {
            ...
            ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 'comment', true, null, 400, function() {
              ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 'comment', '3 points', null, 400, function() {

                // Invalid enabled
                ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 'comment', 10, 'foo', 400, function() {
                  ActivitiesTestUtil.assertEditActivityTypeConfigurationFails(client, course, 'comment', 10, 10, 400, function() {
