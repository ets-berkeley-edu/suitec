 ...
 * @param  {Function}       callback    Standard callback function
 */
var getMeObjects = function(clients, course, callback, meObjects) {
  meObjects = meObjects || [];

  UsersTestUtil.assertGetMe(clients[meObjects.length], course, null, function(me) {
    meObjects.push(me);
    if (meObjects.length === clients.length) {
      return callback(meObjects);
    } else {
      getMeObjects(clients, course, callback, meObjects);
    }
  });
};
