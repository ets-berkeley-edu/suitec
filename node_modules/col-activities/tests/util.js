 ...
 */
var assertTotalPoints = module.exports.assertTotalPoints = function(client, course, userId, activities, callback) {
  assertGetActivityTypeConfiguration(client, course, function(activityTypeConfiguration) {
