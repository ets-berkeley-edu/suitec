 ...
 *
 * The activities will be sorted on when they occurred. Each activity will also include a running
 * total of points for the user that was involved in that activity (including points for the current
 * activity)
 *
 * @param  {Context}          ctx                             Standard context containing the current user and the current course
 * @param  {Function}         callback                        Standard callback function
