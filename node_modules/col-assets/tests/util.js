 ...
 */
var assertAsset = module.exports.assertAsset = function(asset, expectedAsset, incrementViews) {
 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var assertGetAsset = module.exports.assertGetAsset = function(client, course, id, incrementViews, expectedAsset, callback) {
  client.assets.getAsset(course, id, incrementViews, function(err, asset) {
    assert.ok(!err);
    assert.ok(asset);
    assert.strictEqual(asset.id, id);
    assertAsset(asset, expectedAsset, incrementViews);
