 ...
 */
var assertAsset = module.exports.assertAsset = function(asset, expectedAsset, expectedCommentCount, expectedComments, incrementViews) {
...
var assertGetAsset = module.exports.assertGetAsset = function(client, course, id, expectedAsset, expectedCommentCount, callback) {
  client.assets.getAsset(course, id, null, function(err, asset) {
    ...
    assertAsset(asset, expectedAsset, expectedCommentCount, true, true);
