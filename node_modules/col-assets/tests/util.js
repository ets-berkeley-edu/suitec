 ...
 */
var assertAsset = module.exports.assertAsset = function(asset, expectedAsset) {
  ...
  assert(typeof asset.likes === 'number');
  assert(typeof asset.dislikes === 'number');
  assert(typeof asset.views === 'number');
  assert(typeof asset.comments === 'number');
  ...
  if (expectedAsset) {
    ...
    assert.strictEqual(asset.comments, expectedAsset.comments);
 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var assertGetAsset = module.exports.assertGetAsset = function(client, course, id, expectedAsset, callback) {
  client.assets.getAsset(course, id, function(err, asset) {
    assert.ok(!err);
    assert.ok(asset);
    assert.strictEqual(asset.id, id);
    assertAsset(asset, expectedAsset);
