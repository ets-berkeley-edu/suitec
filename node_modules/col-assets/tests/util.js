...
var assertAsset = module.exports.assertAsset = function(asset, expectedAsset, expectedComments, incrementViews) {
  ...
  if (_.isFinite(expectedComments)) {
    ...
    assert.strictEqual(asset.comment_count, expectedComments);
 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var assertGetAsset = module.exports.assertGetAsset = function(client, course, id, expectedAsset, expectedComments, callback) {
  client.assets.getAsset(course, id, function(err, asset) {
    assert.ok(!err);
    assert.ok(asset);
    assert.strictEqual(asset.id, id);
    assertAsset(asset, expectedAsset, expectedComments, true);
