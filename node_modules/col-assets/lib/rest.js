...
Collabosphere.apiRouter.get('/assets/:assetId', function(req, res) {
  AssetsAPI.getAsset(req.ctx, req.params.assetId, req.query.increment_views, function(err, asset) {
    if (err) {
 ...
 */
Collabosphere.apiRouter.post('/assets/:id/comments', function(req, res) {
  AssetsAPI.createComment(req.ctx, req.params.id, req.body.body, req.body.parent, function(err, comment) {
    if (err) {
      return res.status(err.code).send(err.msg);
    }
