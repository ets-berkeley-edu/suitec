 ...
 * @api private
 */
var getAsset = function(ctx, id, opts, callback) {
  opts = opts || {};
...
var getAssets = module.exports.getAssets = function(ctx, filters, limit, offset, callback) {
  ...
  var queryOptions = {
    ...
    'offset': offset,
    'include': [
      // Include whether the current user has liked or disliked each asset
      // `duplicating` is an (as of yet) undocumented feature of Sequelize. It's a hint to Sequelize
  ...
  DB.Asset.findAndCountAll(queryOptions).complete(function(err, result) {
    ...
    // Get all the users that are associated to each of the assets
    var userOptions = {
      'attributes': UserConstants.BASIC_USER_FIELDS,
      'include': [{
        'model': DB.Asset,
...
var createLink = module.exports.createLink = function(ctx, title, url, opts, callback) {
  ...
  return createAsset(ctx, asset, [ctx.user], opts, callback);
};
 ...
 * @param  {String}         imagePath                       The image of this whiteboard
 ...
 */
var createWhiteboard = module.exports.createWhiteboard = function(ctx, whiteboard, imagePath, title, opts, callback) {
  // Default the optional values
  opts = opts || {};
  opts.categories = opts.categories || [];
  ...
  // TODO: Replace this with thumbnailing
  // Upload the image of the whiteboard to Canvas
  CanvasAPI.uploadFileToCanvas(ctx, imagePath, function(err, canvasItem) {
    ...
    createAsset(ctx, asset, whiteboard.members, opts, function(err, asset) {
      if (err) {
        return callback(err);
      }
 ...
 * @param  {User[]}         users                           The user(s) who created the asset
 * @param  {Object}         [opts]                          A set of optional parameters
 * @param  {Number}         [opts.assignment]               The id of the assignment the asset is part of, if any
 ...
 * @api private
 */
var createAsset = function(ctx, asset, users, opts, callback) {
  ...
  CategoriesAPI.getCategoriesById(ctx, opts.categories, function(err, categories) {
    ...
    asset.save().complete(function(err, asset) {
      ...
      asset.setCategories(opts.categories).complete(function(err) {
        ...
        asset.setUsers(_.pluck(users, 'id')).complete(function(err) {
          if (err) {
          ...
          getAsset(ctx, asset.id, false, function(err, asset) {
            ...
            _.each(users, function(user) {
              ActivitiesAPI.createActivity(ctx.course, user, 'add_asset', asset.id, CollabosphereConstants.ACTIVITY.OBJECT_TYPES.ASSET, null, null, function(err) {
                if (err) {
  ...
  embdr.process(assetUrl, {
    ...
    'images': {
      ...
      'complete': function(images) {
        updateAssetPreview(asset, {'imageUrl': images['1038x'].url});
      }
    },
    'error': function(err) {
