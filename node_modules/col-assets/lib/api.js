...
var getAssets = module.exports.getAssets = function(ctx, filters, limit, offset, callback) {
  ...
  // Ensure the category and user ids are numbers
...
var generatePreviews = function(asset) {
  ...
  var embdrConfig = config.get('embdr');
  if (!embdrConfig.enabled || !embdrConfig.apiKey || !assetUrl) {
    return false;
  }

  var embdr = Embdr(embdrConfig.apiKey);
